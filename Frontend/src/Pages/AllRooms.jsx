...
const AllRooms = () => {
    ...
    const handleSortChanges = (sortOptions)=>{
        ...
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            <div>
                <div className="flex flex-col items-start text-left">
                    <h1 className='text-4xl font-sans md:text-[-40px]'>Hotel Rooms</h1>
                    <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>
                        Take advantage of your stay with our limited-time offers and special packages to enhance and create unforgettable memories.
                    </p>
                </div>
                    ...
                    <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                        ...
                        <div className='md:w-1/2 flex flex-col gap-2'>
                            ...
                            <p onClick={() => { navigate(`/rooms/${room._id}`); scrollTo(0, 0) }}
                                className='text-gray-500 text-3xl font-sans cursor-pointer'>
                                {room.hotel.name}
                            </p>
