                    ...
                    <tbody>
                        {rooms.map((item,index)=>(
                            <tr key={index}>
                                ...
                                <td className='py-3 px-4border-t border-gray-300 max-sm:hidden'>
                                    <label className='relative inline-flex items-center cursor-pointer text-sm text-gray-900 gap-3'>
