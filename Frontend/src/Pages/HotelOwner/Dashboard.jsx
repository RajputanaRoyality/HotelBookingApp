...
const Dashboard = () => {
    ...
    return (
        <div>
            <Title align='left' font='outfit' title='Dagsboard' subTitle='Monitor your room listings, track bookings and analyse revenue-all in one place.' />
                ...
                <table className='w-full'>
                    ...
                    <tbody className='text-sm'>
                        {dashboardData.bookings.map((item,index)=>(
                            <tr key={index}>
                                <td className='py-3 text-gray-700 border-t border-gray-300'>
                                    {item.user.username}
                                </td>
