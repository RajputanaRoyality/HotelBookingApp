...
const Navbar = () => {
    ...
    return (
        ...
        <nav className={`fixed top-0 left-0 bg-sky-300 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${isScrolled ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-3 md:py-4" : "py-4 md:py-6"}`}>

            {/* Logo */}
            <Link to="/" className="flex " >
                <img src={assets.logo} alt="" className="h-10 pl-20" />
                <h1 className="font-bold text-2xl mt-1 pl-3">VaisoInc Hotels</h1>
            </Link>
            ...
            <div className="flex mr-15 items-center gap-3 md:hidden">
                {user &&
                    (<UserButton>
                        <UserButton.MenuItems>
                ...
                <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="absolute top-4 right-4 cursor-pointer">
            ...
            <div className={`fixed z-2 top-0 left-0 w-full h-screen bg-white text-base flex flex-col
